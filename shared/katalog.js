...
export const PRESETS = [
  ...
  { id: 'kurumsal-turbo', grup: 'kurumsal', sektor: 'turbo', ad: 'Ölçü Karnesi', icin: 'Turbo revizyon', renk: '#0c7a50' },
  { id: 'klima-sinematik', grup: 'sinematik', sektor: 'klima', ad: 'Soğuk Devre', icin: 'Oto klima', renk: '#5fe3ff' },
  { id: 'turbo-klasik', grup: 'klasik', sektor: 'turbo', ad: 'Salyangoz', icin: 'Turbo revizyon', renk: '#5b34a8' },
  { id: 'turbo-sinematik', grup: 'sinematik', sektor: 'turbo', ad: 'Girdap', icin: 'Turbo revizyon', renk: '#ff6b1c' },
  { id: 'sanziman-klasik', grup: 'klasik', sektor: 'sanziman', ad: 'Yağ Çubuğu', icin: 'Otomatik şanzıman', renk: '#d7193f' },
  ...
  { id: 'kurumsal-ekspertiz', grup: 'kurumsal', sektor: 'ekspertiz', ad: 'Askı Etiketi', icin: 'Oto ekspertiz', renk: '#ffbd12' },
  ...
  { id: 'yikama-klasik', grup: 'klasik', sektor: 'yikama', ad: 'Tünel', icin: 'Oto yıkama ve detay', renk: '#1f3fd1' },
  ...
  { id: 'veteriner-sinematik', grup: 'sinematik', sektor: 'veteriner', ad: 'Sayfa Sayfa', icin: 'Veteriner kliniği', renk: '#43d6b0' },
  { id: 'kurumsal-dizel', grup: 'kurumsal', sektor: 'dizel', ad: 'Menzür', icin: 'Dizel enjektör ve pompa', renk: '#2455ff' },
  { id: 'kurumsal-veteriner', grup: 'kurumsal', sektor: 'veteriner', ad: 'Pati Karnesi', icin: 'Veteriner kliniği', renk: '#0b6f6a' },
  { id: 'yikama-sinematik', grup: 'sinematik', sektor: 'yikama', ad: 'Köpük Tüneli', icin: 'Oto yıkama ve detay', renk: '#ff7a33' },
  { id: 'kurumsal-yikama', grup: 'kurumsal', sektor: 'yikama', ad: 'Karnauba', icin: 'Oto yıkama ve detay', renk: '#f2a516' },
  { id: 'dizel-sinematik', grup: 'sinematik', sektor: 'dizel', ad: 'Menzür', icin: 'Dizel enjektör ve pompa', renk: '#f5a524' },
  { id: 'restoran-klasik', grup: 'klasik', sektor: 'restoran', ad: 'Bakır Sini', icin: 'Ocakbaşı restoran', renk: '#1f6b45' },
  ...
  { id: 'kilit-klasik', grup: 'klasik', sektor: 'kilit', ad: 'Çift Flaş', icin: 'Oto kilit ve anahtar', renk: '#ff8f1f' },
